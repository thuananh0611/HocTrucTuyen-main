...
<div class="sb2-2">
    ...
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="active-bre"><a href="#"> Thông tin cá nhân</a>
            </li>
    ...
    <div class="sb2-2-3">
        <div class="row" style="background: #fff">
            <div class="box-inn-sp admin-form">
                <div class="col-md-3">
                    <div class="pro-user" style="margin-top: 25px;">
                        <img src="images/user.jpg" alt="user">
                    </div>
                    <div class="pro-user-bio">
                        <ul>
                            <li>
                                <h4>Victoria Baker</h4>
                            </li>
                            <li>Teacher Id: GV0001</li>
                            <li><a href="#!"><i class="fa fa-facebook"></i> Facebook: Victoria</a></li>
                            <li><a href="#!"><i class="fa fa-google-plus"></i> Google: Victoria@gmail.com</a></li>
                            <li><a href="#!"><i class="fa fa-twitter"></i> Twitter: Victoria</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-9">
